...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $this->addWeatherDisplayOwerview($form, $form_state);
    ...
    $form['import_places']['description'] = [
      '#type' => 'markup',
      '#prefix' => '<span>',
      '#markup' => $this->t('After first installation, you need to import weather places into the system'),
      '#suffix' => '</span>',
    ];
   ...
   */
  protected function addWeatherDisplayOwerview(array &$form, FormStateInterface $form_state) {
      ...
      $form['system_displays'][$display_number] = [
        ...
        '#header' => [
          Link::fromTextAndUrl(
            ...
            Url::fromRoute('entity.weather_display.edit_form', ['weather_display' => $display->id()])
          ),
          $this->t('Weight'),
        ],
      ];
